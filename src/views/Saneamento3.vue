                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2 mb-2">
                            <label for="cbUfModalLote">UF
                                <i class="fas fa-info-circle mr-2" title="Escolha mais de uma UF se necessário" style="color: steelblue"></i>

                                <label for="chkTodasUFs">Todas: </label>
                                <input class="mt-2 ml-2 mr-2" type="checkbox" id="chkTodasUFs" v-model="marcarTodasUfs" v-on:click="MarcarTodasUFs()" />
                            </label>

                            <div id="divUfsLote">
                                <div v-for="(item, index) in ufsModalLote" :key="item">
                                    <label for="item.sigla" class="corLabelCombo">{{ item.sigla }}</label>
                                    <input class="ml-2 mr-2" type="checkbox" v-bind:id="'chk' + item.sigla" v-bind:name="item.sigla" v-bind:checked="item.checado" v-on:click="ChecarLstUFsLote(index, 'chk' + item.sigla)" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-2">
                            ...
                            <select id="selectCFOP" class="form-control form-control-sm" v-model="cfop" @change="DefineCFOP(cfop.substring(0, 1))">
                                <option v-for="item in cfops" :key="item.tipo" :value="item.tipo">
                                    {{ item.descricao }}
                                </option>
                            </select>
                        </div>

                        <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2 mb-2" v-if="digitarCfopManual">
                            <label for="cfop">Digite o CFOP:</label>
                            <input type="number" class="form-control" v-model="cfopManual" id="cfop" v-on:blur="DefineTipoPessoa(cfopManual.toString().substring(0, 1))" />
                        </div>

                        <div :class=" (digitarCfopManual) ? 'col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-2' : 'col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-2'">
                            <label for="cbCaracTrib">Característica Tributária
                                <i class="fas fa-info-circle" title="do Remetente/Destinatário." style="color: steelblue"></i></label>
                            <select class="form-control form-control-sm" v-model="caracTrib" name="cbCaracTrib">
                                <option v-for="(item, index) in caracTrib_" v-bind:key="index" v-bind:value="item.value" v-on:click="InformacaoSimples(caracTrib)">
                                    {{ item.text }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-12 col-md-6 col-lg-2 col-xl-2 mb-2">
                            ...
                            <select class="form-control form-control-sm" v-model="substICMSRemDest" name="cbSubstICMSRemDest">
                                <option v-for="(item, index) in substICMSRemDest_" v-bind:key="index" v-bind:value="item.value">
                                    {{ item.text }}
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-2 col-xl-2 mb-2" v-if="mostrarSimples">
                            <label for="cbSimples">Simples Nacional</label>
                            <select class="form-control form-control-sm" v-model="simples" name="simples">
                                <option v-for="(item, index) in simplesNac" v-bind:key="index" v-bind:value="item.value">
                                    {{ item.text }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 mb-2">
                            ...
                            <select class="form-control form-control-sm" v-model="finalidade" name="finalidade">
                                <option v-for="(item, index) in finalidade_" v-bind:key="index" v-bind:value="item.value">
                                    {{ item.text }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7 mb-2">
                            ...
                            <select class="form-control form-control-sm" v-model="origem" name="origem">
                                <option v-for="(item, index) in origem_" v-bind:key="index" v-bind:value="item.value">
                                    {{ item.text }}
                                </option>
                            </select>
                        </div>
...
<div class="row mt-4">
    <div class="col-md-2">
        <select class="form-control form-control-sm" v-model="criterio" id="selectCriterio" v-on:click="LimparCamposCriterio(criterio)">
    ...
    <div class="col-md-2 mb-2" v-if="criterio == 'DESCRICAO'">
        <select class="form-control form-control-sm" v-model="tipoDescr" id="selectTipoDescricao">
    ...
    <div class="col-md-1 mb-2" v-if="criterio == 'NCM'">
        <input type="text" class="form-control form-control-sm" v-model="exIPI" id="exIPI" maxlength="2" placeholder="Ex. IPI" />
    </div>
    <div class="col-md-3 mb-2">
        <input class="form-control form-control-sm valor" v-model="valor" id="valor" v-bind:placeholder="'Informe ' + DescricaoTxtValor(criterio)" v-on:blur="BuscarDescricao(valor)" />
    </div>
    <div class="col-md-2 mb-1" v-if="criterio == 'DESCRICAO'">
        <input type="text" class="form-control form-control-sm" v-model="cest" id="cest" maxlength="10" placeholder="CEST" v-on:keyup.enter="Consult(valor, criterio, exIPI)" />
    </div>
    <div class="col-md-3" v-if="criterio == 'GTIN'">
        <input class="form-control form-control-sm valor" v-model="descricao" id="descricao" disabled placeholder="Descrição" />
    </div>
    <div class="col-md-2">
        <button class="geral-button" @click="BuscarDadosConsultas(valor, criterio)">
            Consultar
        </button>
    </div>
    <div class="col-md-2 ml-auto mt-2 text-right" v-if="criterio == 'GTIN' && userLogged">
        <a href="" class="btn-lote" data-toggle="modal" data-target="#modalConsultaLote" @click="VerificarTipoConsulta()">Consultar em lote</a>
    </div>
</div>

<div id="divHistorico">
    <div class="d-inline" v-for="item in ListaHistorico" :key="item.chave">
        <HistoryButtons @excluir-elemento="ExcluirComponente" @consult="BuscarDadosConsultas" v-bind:key="item.chave" v-bind:valor="item.valor" />
    </div>
</div>
    ...
    <div class="col-md-12 mt-2">
        <div class="row">
            ...
            <div class="col-md-1 float-right mb-1 mt-2">
                <select class="form-control form-control-sm" v-model="limite" v-if="principal.length > 10" title="Altera o limite de produtos por página." v-on:change="
              pagina = 1;
              PaginarTabela();
            ">
        ...
        <table class="table table-responsive" id="tblResultadoPrincipal" v-show="false">
            <thead>
                <tr>
        ...
        <table class="table table-divider table-striped table-sm table-responsive-lg tableFixHead table-bordered" id="tabelaPrincipal" v-if="principal.length > 0">
            <thead>
                <tr>
                    <th>Descrição</th>
                    <th>UF</th>
...
<div class="row">
    <div class="col-md-5 col-lg-3 mt-3 mb-2">
        <button class="geral-button btn-sm ml-1" v-if="exportar == true" data-toggle="modal" data-target="#modalExportacao" data-backdrop="static" data-keyboard="false">
            Exportar
        </button>
    </div>
    <template v-if="qtdePaginas > 1 && principal.length > 0">
            ...
            <nav class="d-lg-flex justify-content-end overflow-auto" aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item" v-if="pagina != 1">
                        <a class="page-link" v-on:click.prevent.stop="
                  pagina = 1;
                  OrganizarNavegacao();
                " href="#"><i class="fas fa-angle-double-left"></i>
                  ...
                  pagina--;
                  OrganizarNavegacao();
                " href="#"><i class="fas fa-angle-left"></i></a>
                    </li>
                    <li v-for="item in paginaNavegacao" class="page-item" :class="{ active: item === pagina }" v-on:click.prevent.stop="
                pagina = item;
                OrganizarNavegacao();
              " :key="item">
                        <a class="page-link" href="#">{{ item }}</a>
                    </li>
                    <li class="page-item" v-if="pagina < qtdePaginas" v-on:click.prevent.stop="
                pagina++;
                OrganizarNavegacao();
              ">
                        <a class="page-link" href="#"><i class="fas fa-angle-right"></i></a>
                    </li>
                    <li class="page-item" v-if="qtdePaginas > 1 && pagina < qtdePaginas" v-on:click.prevent.stop="
                pagina = qtdePaginas;
                OrganizarNavegacao();
              ">
        ...
        <div class="col-md-3 col-lg-2 mt-3">
            <input type="number" class="form-control valor" placeholder="Página" v-model="paginaEscolhida" v-on:keyup.enter="
            pagina = paginaEscolhida;
            OrganizarNavegacao();
          " />
            <div id="lupa" v-on:click="
            pagina = paginaEscolhida;
            OrganizarNavegacao();
          ">
...
<!-- Modal Exportação -->
<div class="modal fade" id="modalExportacao" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="cbTipoExportacao" class="col-form-label">Tipos de Exportação:</label>
                        <select class="form-control" id="cbTipoExportacao" v-model="tipoExportacao">
                            <option v-for="i in tiposExportacao" v-bind:key="i.tipo" v-bind:value="i.tipo">
                                {{ i.descricao }}
                            </option>
                        </select>
                    </div>
                    <div class="form-group" v-if="tipoExportacao == 0 || tipoConsulta == 5">
            ...
            <div class="modal-footer">
                <button type="button" class="btn geral-button primary btn-sm" data-dismiss="modal">
                    Cancelar
                </button>
                <button v-if="tipoExportacao == 0" type="button" class="btn geral-button btn-sm" v-on:click="RetornarExportacao()">
                    Enviar Exportação
                </button>
                <button v-else type="button" class="btn geral-button btn-sm" v-on:click="RetornarExportacao()">
                    Exportar
                </button>
            </div>
        </div>
...
<div class="modal fade bd-example-modal-lg" id="modalConsultaLote" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true" ref="vuemodal">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <input class="mr-1" type="checkbox" id="chkLote" v-model="chkLote" v-on:click="ControlarCheckLote()" />
                ...
                <div class="row">
                    <div class="col-md-8">
                        <input type="email" class="form-control form-control-sm" id="emaillote" placeholder="Insira o e-mail..." v-model="emailLote" :disabled="dEmailLote" />
                    </div>
                </div>
                ...
                <h6>
                    ...
                    <i class="fas fa-info-circle" title="O arquivo CSV ou XLSX deve seguir o mesmo padrão apresentado acima, cada produto deve estar em uma linha, separados por (;) no caso do CSV, separar por colunas no arquivo XLSX." style="color: steelblue">
                    </i>
                </h6>
                        ...
                        <div class="input-group input-sm">
                            ...
                            <label class="input-group-btn">
                                <span class="btn btn-sm btnModalGeral">
                                    ...
                                    <input id="file-upload" type="file" accept=".csv, .ods, .xlsx" style="display: none" v-on:change="EnviarDadosArquivo($event, this)" />
                                </span>
                            </label>
                ...
                <textarea class="form-control form-control-sm mt-2" v-model="consLote" id="consultaLote" rows="5" autofocus placeholder="Código..."></textarea>

                <input class="mt-3 mr-1" type="checkbox" id="chkExportarResultado" checked v-on:click="ExportarTodos()" />
            ...
            <div class="modal-footer">
                <div class="mr-auto">
                    <button type="button" class="btn btnModalPrimary" title="Exporta em formato de planilha um exemplo de como deve ser montado o arquivo para importacao." v-on:click="
              ...
              ">
                    ...
                    <button type="button" class="btn btnModalPrimary ml-2" title="Exporta em formato de planilha um exemplo de como deve ser montado o arquivo para importacao." v-on:click="
                GerarPlanilhaXLSXCSV(
                  'TblExemplo',
                  'Exemplo de Arquivo por Códigos',
                  'csv'
              ...
              ">
                ...
                <button type="button" class="btn btnModalGeral" name="btnConsultarProdutos" data-dismiss="modal" v-on:click="ConsomeAPI(1)">
...
<ConsultDetailsGrades v-if="mostrarDetalhes" :p_detalhes="detalhes"></ConsultDetailsGrades>
</template>
...
export default {
    ...
    methods: {
        async ConsomeAPI(tipo) {
            ...
            if (this.ValidarCampos(cnpj, ufOrig, this.uf, cfopEnvio, crt, this.codigo, this.descricao)) {
                let user = "";
                let pwd = "";
                ...
                envio.emit = this.DadosEmpresaGT(2, cnpj, crt, tipoRPA, ufOrig, cnaeEnvio, this.interdependente, this.substICMS, dia, mes, ano);
                envio.perfil = this.DadosPerfilEmitenteDestinatario(uf, cfopEnvio, caracTribEnvio, this.finalidade, this.simples, this.origem, this.substICMSRemDest);
                envio.produtos = this.PreencherProdutos(tipo);

                if (envio.produtos.length == 0) {
                    this.alertStore.error("Não foi possível enviar nenhum produto, por favor enviar todos com descrição");
                    this.retorno = null;
                ...
                let data = await CallPostAsync(user, pwd, url, envio, true)
                    .then((data) => {
                        ...
                        userStore.user.dataQueries.RetornoConsultaIndividual =
                            JSON.stringify(data);
                        this.exportar = true;
                        this.processando = false;
                    })
        ...
        PreencherLinhas(grupo, codigo, descricao, indice, array) {
            ...
            grupo.Regras[0].uFs.forEach((uf) => {
                ...
                linha.aliqIcmsInterestadual = uf.CFOP.CaracTrib[0].aliqIcmsInterestadual;
                ...
                if( uf.CFOP.CaracTrib[0].Pmpf ){
                    linha.aPmpf = uf.CFOP.CaracTrib[0].Pmpf;
                }
                //----------------------------------------------------------------------
        ...
        DadosEmpresaGT(amb, cnpj, crt, regime, uf, cnae, interdependente, substICMS, dia, mes, ano, regimeEspecial) {
            var emit = new Object();
        ...
        DadosPerfilEmitenteDestinatario( uf, cfop, cTrib, finalidade, simples, origem, substICMS) {
        ...
        ObterCodigoImendesNCM(ncm) {
            ...
            let urlToken = RetUrlAPI("Integracoes", "v1") + "login";
            let url = RetUrlAPI("Integracoes", "v1") + "consulta-ncm";
        ...
        GerarJSONExportacaoGrupos(lote) {
            ...
            if (lote)
                retorno = JSON.parse(userStore.user.dataQueries.RetornoConsultaLote);
            else
                retorno = JSON.parse(
                    userStore.user.dataQueries.RetornoConsultaIndividual
                );
        ...
        GerarJSONExportacaoSemRetorno() {
            ...
            let retorno = JSON.parse(userStore.user.dataQueries.RetornoConsultaLote);
